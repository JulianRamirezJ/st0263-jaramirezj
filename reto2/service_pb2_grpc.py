...
def add_GetFileServicer_to_server(servicer, server):
    rpc_method_handlers = {
...
class GetFile(object):
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GetFile/List',
